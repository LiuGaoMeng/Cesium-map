    ...
    methods: {
        ...
        initObject() {
            const rectangle = this.viewer.entities.add({
                id: 'rectangle', // 对象的唯一标识符。如果未提供，则将生成GUID。
                name: 'rectangle', // 要显示给用户的可读名称。它不必是唯一的。
            ...
            this.viewer.entities.add({
                rectangle: {
                    ...
                    material: '/image/billboard.jpg',
                    rotation: new Cesium.CallbackProperty(this.getRotationValue(this.rotation), false),
                    stRotation: new Cesium.CallbackProperty(this.getRotationValue(this.rotation), false),
